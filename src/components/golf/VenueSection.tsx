  ...
  return (
    <section className="relative py-8 md:py-16 overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4">
        ...
        >
          <h2 className="font-sport text-3xl md:text-5xl text-white mb-2 md:mb-4 drop-shadow-lg">
            TOURNAMENT VENUE
          </h2>
          <p className="text-sm md:text-xl text-white/90 max-w-3xl mx-auto drop-shadow">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-8 items-start">
          ...
          <div className="space-y-4 md:space-y-6">
            <motion.div
              ...
              transition={{ duration: 0.6 }}
              viewport={{ once: true }}
              className="bg-white rounded-lg shadow-xl overflow-hidden h-[250px] md:h-[400px]"
            >
              <iframe
            ...
            >
              ...
              />
              <div className="p-3 md:p-6 bg-gradient-to-r from-steel-blue to-dark-steel">
                <p className="text-white font-bold text-sm md:text-lg text-center">
                  Premium golf carts included for all participants
                </p>
                <p className="text-ice-blue text-xs md:text-sm text-center mt-1 md:mt-2">
          ...
          >
            ...
            <div className="bg-white rounded-lg shadow-xl p-4 md:p-8">
              <h3 className="font-sport text-xl md:text-3xl text-dark-steel mb-3 md:mb-6">
            ...
            {/* Schedule Card */}
            <div className="bg-gradient-to-r from-steel-blue to-dark-steel rounded-lg shadow-xl p-4 md:p-8 text-white">
              <h4 className="font-sport text-xl md:text-2xl mb-3 md:mb-4">Event Schedule</h4>
            ...
            {/* About Venue */}
            <div className="bg-white rounded-lg shadow-xl p-4 md:p-8">
              <h4 className="font-bold text-lg md:text-xl text-dark-steel mb-2 md:mb-3">About the Venue</h4>
              ...
              <a 
                href="https://ramblewoodcc.com/course-details/" 
                target="_blank" 
                rel="noopener noreferrer"
