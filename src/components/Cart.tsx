              ...
              <>
                ...
                <div className="border-t border-steel-gray/30 p-6">
                  ...
                  <button
                    ...
                    className="w-full bg-steel-blue text-white py-3 rounded font-oswald hover:bg-ice-blue transition-colors mb-1"
                  >
                    Proceed to Checkout
                  </button>
                  <p className="text-center text-steel-gray text-xs mb-2 flex items-center justify-center gap-1">
