...
SELECT 'Current players:' as info;
SELECT name, jersey_number, position FROM players ORDER BY jersey_number;
...
-- Verify the data
SELECT 'New roster:' as info;
SELECT name, jersey_number, position, tags FROM players ORDER BY jersey_number;